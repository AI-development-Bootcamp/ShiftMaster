...
export interface IAdminTaskAssignmentRepository extends IBaseRepository<
  AdminTaskAssignment,
  NewAdminTaskAssignment,
  UpdateAdminTaskAssignment
> {
  ...
  findAllActive(): Promise<AdminTaskAssignment[]>;
  revoke(id: string): Promise<void>;
}

export interface IEntryRepository extends IBaseRepository<
  Entry,
  NewEntry,
  UpdateEntry
> {
...
export interface IEntryAssignmentRepository extends IBaseRepository<
  EntryAssignment,
  NewEntryAssignment,
  UpdateEntryAssignment
> {
...
export interface IMonthLockRepository extends IBaseRepository<
  MonthLock,
  NewMonthLock,
  UpdateMonthLock
> {
